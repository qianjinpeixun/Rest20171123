...
public class Card {
    ...
    // The ranks, in order from lowest to highest, are: 2, 3, 4, 5, 6, 7, 8, 9,
    ...
    // (note that suit is irrelevant when comparing rank; the Ace of Spades is
    // “worth” as much as an Ace of Hearts)
