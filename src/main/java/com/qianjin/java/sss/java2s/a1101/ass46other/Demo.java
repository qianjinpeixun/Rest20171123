...
public class Demo {
    ...
    private static PlayerHand pile1;
    private static PlayerHand pile2;
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            firstWin = false;
            secondWin = false;
            Card card1 = pile1.draw();
            Card card2 = pile2.draw();
            war1.add(card1);
            war2.add(card2);
            if (card1.higher(card2)) {
                ...
                while (true) {
                    ...
                    Card c11 = pile1.draw(index);
                    Card c12 = pile1.draw(index + 1);
                    Card c21 = pile2.draw(index);
                    Card c22 = pile2.draw(index + 1);
                    war1.add(c11);
                    war1.add(c12);
                    war2.add(c21);
                    war2.add(c22);
