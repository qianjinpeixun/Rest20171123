    ...
    public static void main(String[] args) {
        ...
        do {
            if (turns == 0) {
                ...
                hand1.clear();
                for (int i = 0; i < 26; i++) {
                    hand1.add(deck.getPile().getNode(i).getData());
                }
                hand2.clear();
                for (int i = 26; i < 52; i++) {
                    hand2.add(deck.getPile().getNode(i).getData());
                }
                System.out.println("");
                System.out.println(p1 + "                   #Cards         " + p2 + "                   #Cards        Winner");
            } else {
                Card card1 = hand1.look(top1);
                Card card2 = hand2.look(top2);
                ...
                if (card1.comparision(card2)) {
                    ...
                    while (!winner) {
                        ...
                        Card card01 = hand1.look(top1 - 1);
                        Card card02 = hand2.look(top2 - 1);
