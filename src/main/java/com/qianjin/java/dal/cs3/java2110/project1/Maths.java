...
public final class Maths {
    ...
    private final FactorialUtils<Integer, BigInteger> cache = new FactorialUtils<>();
     ...
     * Zero factorial is equal to 1. For values of n greater than 20 you must
     * use {@link #bigFactorial(int)}.
     * 
     * @param n
    ...
    /**
     * Calculates the factorial of n where n is a positive integer. Zero
     * factorial is equal to 1. For values of n up to 20, consider using
     * {@link #factorial(int)} instead since it uses a faster implementation.
     * 
     * @param n
     *            The factorial to calculate.
     * @return The factorial of n.
    ...
    public static BigInteger newbigFactorial(int n) {
        if (n < 0) {
            throw new IllegalArgumentException("Argument must greater than or equal to zero.");
        }
        BigInteger factorial = null;
    ...
    /**
     * Calculate the first argument raised to the power of the second. This
     * method only supports non-negative powers.
     * 
     * @param value
    ...
    /**
     * Checks that two values are approximately equal (plus or minus a specified
     * tolerance).
     * 
     * @param value1
     ...
     * @param tolerance
     *            How much (in percentage terms, as a percentage of the first
     *            value) the values are allowed to differ and still be
     *            considered equal. Expressed as a value between 0 and 1.
    ...
    /**
     * If the specified value is not greater than or equal to the specified
     * minimum and less than or equal to the specified maximum, adjust it so
     * that it is.
     * 
     * @param value
     *            The value to check.
     ...
     * @return {@code value} if it is between the specified limits, {@code min}
     *         if the value is too low, or {@code max} if the value is too high.
     * @since 1.2
     */
