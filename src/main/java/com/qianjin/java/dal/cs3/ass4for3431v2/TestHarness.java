package com.qianjin.java.dal.cs3.ass4for3431v2;
 ...
 *
 * I.e. java TestHarness <input file> 10 5 7
 *
 * Once this is entered, the user enters "*" to output the state of the bank. Or
 * users may enter input on the command line by using the following: [RQ || RL]
 * <customer number> <resource #1> <#2> <#3>
 * 
 * For example, customer 4 performing a request for 2 of resource 1, 3 of
 * resource 2, and 5 of resource 3 would enter RQ 4 2 3 5
 */
