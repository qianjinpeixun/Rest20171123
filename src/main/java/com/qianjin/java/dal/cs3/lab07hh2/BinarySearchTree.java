...
// extend Comparable<T>
{
    ...
    public T findMax() {
        ...
        // got the most right node, it's the largest value
        return t;
    }
    ...
    public T findMin() {
        ...
        // got the most left node, it has the smallest value
        return t;
    }
    ...
    public BinaryTree<T> recursiveSearch(BinaryTree<T> t, T key) {
        if (t == null) {
            ...
            return recursiveSearch(t.getLeft(), key);// look left sub tree
        } else if (key.compareTo(t.getData()) > 0) {
            return recursiveSearch(t.getRight(), key);// look right sub tree
        }
        return null;
    }
