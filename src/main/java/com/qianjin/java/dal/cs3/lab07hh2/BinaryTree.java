package com.qianjin.java.dal.cs3.lab07hh2;
...
public class BinaryTree<T extends Comparable<T>> {
    ...
    private static String inOrderResult="";


  
    public static String getInOrderResult() {
        return inOrderResult;
    }

    public static void setInOrderResult(String inOrderResult) {
        BinaryTree.inOrderResult = inOrderResult;
    }
    ...
    public static <T extends Comparable<T>> void printinorder(BinaryTree<T> t) {
        if (t != null) {
            printinorder(t.getLeft());
            inOrderResult=inOrderResult+t.getData() + " ";
