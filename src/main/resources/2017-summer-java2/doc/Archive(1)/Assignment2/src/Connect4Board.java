/*Assignment2, Question 1 CSCI 1101
  Connect4Board.java game is judge who is winner.How to be winner.
   July 12, 2017
...
public class Connect4Board extends Board {
    ...
    public boolean add(int c, String colour) {//add a Chip of the given colour in the column indicated by the parameter
